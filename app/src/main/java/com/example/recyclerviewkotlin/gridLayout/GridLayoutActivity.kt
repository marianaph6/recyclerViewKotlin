...
class GridLayoutActivity : AppCompatActivity(), MovieOnClickListener {

    private lateinit var binding: ActivityGridLayoutBinding

    private lateinit var adapterMovies: MovieGridLayoutAdapter
    ...
    private fun initRecyclerView() {
        adapterMovies = MovieGridLayoutAdapter(data, this)
