...
import com.example.recyclerviewkotlin.databinding.ActivityStaggeredGridBinding
import com.example.recyclerviewkotlin.commons.Movie

class StaggeredGridActivity : AppCompatActivity(), MovieOnClickListener {

    private lateinit var binding: ActivityStaggeredGridBinding

    private lateinit var adapterMovies: MovieStaggeredGridAdapter
    ...
    private fun initRecyclerView() {
        adapterMovies = MovieStaggeredGridAdapter(data, this)
