...
import com.example.recyclerviewkotlin.databinding.ActivityLinearHorizontalBinding
import com.example.recyclerviewkotlin.commons.Movie

class LinearHorizontalActivity : AppCompatActivity(), MovieOnClickListener {

    private lateinit var binding: ActivityLinearHorizontalBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityLinearHorizontalBinding.inflate(layoutInflater)
    ...
    private fun initRecyclerView() {
        ...
        with(binding.recyclerView) {
            layoutManager = LinearLayoutManager(this@LinearHorizontalActivity, LinearLayoutManager.HORIZONTAL, false)
